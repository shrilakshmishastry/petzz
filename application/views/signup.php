         ...
         <li><a class="navbarText dropdown-item" href="#">Nutrition Counselling</a></li>
          ...
          <!-- row for user name -->
					<div class="row  mt-5 pl-3 ">
						...
						<input type="text" name="Full	Name" class="bg-white border-top-0 border-end-0 border-start-0 border-info "  id="Full	Name" value="" placeholder=""  required>
					</div>
					<!-- row for name -->
					<div class="row mt-5 pl-3 ">
              ...
              <a href="#" class="pe-lg-5 ps-lg-5 themeFontMedium mt-3 btn btn-outline-primary pl-lg-5 rounded-pill pr-lg-5">
                Submit
					...
					<div class="row mt-3">
						...
						<a href="<?php echo base_url('/petzz/index.php/Login/index') ?>" class="textPrimary">Login </a>&nbsp; Now
            </p>
					</div>
				</div>
        <div class="col-md-6 pr-md-0  col-lg-7 offset-lg-1 d-none d-sm-block position-relative">
          <img class="img-fluid position-absolute top-0 end-0" src="<?php echo base_url('/petzz/images/loginDog.png') ?>" alt="beautiful dog image">
        </div>
			</div>
      <!-- footer -->
