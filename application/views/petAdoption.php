  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row mt-5 justify-content-center">
          <div class="col-lg-2 col-md-4 ml-md-5 col-8 ">
            <div class="card rounded-3 shadow">
              	<img class="imgCard rounded-3 card-img-top" src="<?php echo base_url('/petzz/images/5.png') ?>" alt="logo">
                <div class="card-body cardBodyColor">
                  <p class="textSecondary themeFontMedium fs-5" >Belly bum</p>
                  <div class="d-flex flex-row justify-content-between">
                    <small class="textSecondary">1 year old</small>
                    <small class="textSecondary"> Female</small>
                  </div>
                </div>
            </div>
          </div>
