...
class OrderSummaryFunHandler extends CI_Model{
	public function get_order_list($email)
	{
		$query1 = "SELECT id FROM order_detail where user_email = '$email'";
		...
		$query = "
			SELECT
			    ...
			    ol.product_img as image,o.id as order_id,o.pet_store as shop_name  
		  	FROM
				order_detail as o
			INNER JOIN
				order_items as ol
